...
philosophical_question = prompt (`What is the correct answer to the main question of life, the universe and all that?`);
philosophical_question = philosophical_question ? philosophical_question.trim().toLowerCase() : ``;
